            ...
            if self.is_visible(target_element_locator):
                ...
                if direction == 'up':
                    self.driver.swipe(
                        ...
                        scrollable_element_attributes['top'] + 200,
                        scrollable_element_attributes['center_x'],
                        scrollable_element_attributes['bottom'] - 200,
                        duration
                    )
                elif direction == 'down':
                    self.driver.swipe(
                    ...
                    self.driver.swipe(
                        scrollable_element_attributes['left'] + 200,
                        scrollable_element_attributes['center_y'],
                        scrollable_element_attributes['right'] - 200,
                        scrollable_element_attributes['center_y'],
                        duration
                    )
